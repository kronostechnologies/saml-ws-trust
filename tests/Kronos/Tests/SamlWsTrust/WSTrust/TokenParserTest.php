...
class TokenParserTest extends TestCase
{
     ...
     */
    protected function getValidSAML20RTSP(): string
    {
        return self::getMockAssetionContent(self::VALID_SAML_20_RTSP_FILE);
    }
    ...
    {
        return self::getMockAssetionContent(self::VALID_SAML_20_CRYPT_RTSP_FILE);
    }
    ...
    {
        return self::getMockAssetionContent(self::VALID_SAML_20_CRYPT_RTSP_DECRYPTED_ASSERTION_FILE);
    }
    ...
    {
        return self::getMockAssetionContent(self::SAML_20_MANY_ASSERT_FILE);
    }
    ...
    {
        return self::getMockAssetionContent(self::SAML_20_NO_ASSERT_FILE);
    }
    ...
    {
        return self::getMockAssetionContent(self::SAML_20_ENC_MANY_ASSERT_FILE);
    }
    ...
    {
        return self::getMockAssetionContent(self::SAML_20_ENC_NO_ASSERT_FILE);
    }
     ...
     * @return non-empty-string
     */
    private static function getMockAssetionContent(string $fileName): string
    {
        $value = trim(file_get_contents($fileName));
        if(empty($value)) {
            throw new \InvalidArgumentException("Unexpected empty file");
        }
        return $value;
    }
}
